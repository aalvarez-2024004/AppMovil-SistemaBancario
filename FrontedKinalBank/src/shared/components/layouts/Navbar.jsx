...
export const Navbar = ({ sidebarOpen, onToggleSidebar }) => {
    ...
    return (
        <header className="h-[78px] bg-[#071126]/95 backdrop-blur-xl border-b border-white/5 flex items-center justify-between px-4 sm:px-8 sticky top-0 z-50 flex-shrink-0 relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-center gap-3 sm:gap-5">
                ...
                {/* Hamburguesa (solo mobile) - ahora vive DENTRO del navbar */}
                {onToggleSidebar && (
                    <button
                        onClick={onToggleSidebar}
                        className="lg:hidden w-11 h-11 flex-shrink-0 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md flex flex-col items-center justify-center gap-1.5 text-white active:scale-95 transition-all"
                    >
